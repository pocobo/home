var f = (w, s, e) =>
  new Promise((n, m) => {
    var r = (i) => {
      ...
      l = (i) => (i.done ? n(i.value) : Promise.resolve(i.value).then(r, u));
    l((e = e.apply(w, s)).next());
  });
      ...
      const s = [
          {
            ...
            children: [
              ...
              { title: '默认输入状态', dataIndex: 'name7', editRow: !0, width: 150 },
              {
                title: '输入框校验',
                dataIndex: 'name1',
                editRow: !0,
          ...
          },
          {
            ...
            editRule: !1,
            editComponentProps: { api: g, resultField: 'list' },
            width: 200,
          },
          {
            title: '日期选择',
        ...
        [m] = x({
          ...
          actionColumn: { width: 160, title: 'Action', dataIndex: 'action' },
        });
      function r(t) {
        var a;
        (n.value = t.key), (a = t.onEdit) == null || a.call(t, !0);
      }
      function u(t) {
        var a;
        (n.value = ''), (a = t.onEdit) == null || a.call(t, !1, !1);
      }
      function l(t) {
        return f(this, null, function* () {
          var o, p;
          if (
            (e.loading({ content: '正在保存...', duration: 0, key: 'saving' }),
            yield (o = t.onValid) == null ? void 0 : o.call(t))
          )
            try {
              const R = k(t.editValueRefs);
              (yield (p = t.onEdit) == null ? void 0 : p.call(t, !1, !0)) && (n.value = ''),
                e.success({ content: '数据已保存', key: 'saving' });
            } catch (R) {
              e.error({ content: '保存失败', key: 'saving' });
            }
          else e.error({ content: '请填写正确的数据', key: 'saving' });
        });
      }
      function i(t) {
        return t.editable
          ? [
              { label: '保存', onClick: l.bind(null, t) },
              { label: '取消', popConfirm: { title: '是否取消编辑', confirm: u.bind(null, t) } },
            ]
          : [
              {
                label: '编辑',
                disabled: n.value ? n.value !== t.key : !1,
                onClick: r.bind(null, t),
              },
            ];
      }
      function d({ column: t, value: a, record: o }) {
        t.dataIndex === 'id' && (o.editValueRefs.name4.value = `${a}`);
      }
      return (t, a) => (
        h(),
        F('div', Y, [
          M(
            c(b),
            { onRegister: c(m), onEditChange: d },
            {
              bodyCell: A(({ column: o, record: p }) => [
                o.key === 'action'
                  ? (h(), E(c(v), { key: 0, actions: i(p) }, null, 8, ['actions']))
                  : S('', !0),
              ]),
              _: 1,
            },
