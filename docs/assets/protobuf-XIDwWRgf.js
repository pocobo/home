...
(function (f, i) {
  (function (r) {
    ...
    var t = [
      ...
      o = n(t);
    r.registerHelper('hintWords', 'protobuf', t);
    var a = new RegExp('^[_A-Za-z¡-￿][_A-Za-z0-9¡-￿]*');
    function p(e) {
      return e.eatSpace()
        ? null
        : e.match('//')
    ...
    r.defineMode('protobuf', function () {
      return { token: p, fold: 'brace' };
    }),
      r.defineMIME('text/x-protobuf', 'protobuf');
  });
})();
var u = b.exports;
const l = c(u),
  m = s({ __proto__: null, default: l }, [u]);
export { m as p };
