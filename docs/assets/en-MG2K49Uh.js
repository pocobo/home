...
var a = (t, e, o) =>
    e in t ? me(t, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (t[e] = o),
  n = (t, e) => {
    for (var o in e || (e = {})) be.call(e, o) && a(t, o, e[o]);
    if (r) for (var o of r(e)) he.call(e, o) && a(t, o, e[o]);
    return t;
  },
  i = (t, e) => pe(t, ge(e));
import { g as fe } from '../index.js';
import { N as Te } from './antd-BmrhB3rb.js';
...
const s = 'OK',
  ...
  w = { searchNotData: 'No search results yet', toSearch: 'to search', toNavigate: 'to navigate' },
  k = { normalText: 'Get SMS code', sendText: 'Reacquire in {0}s' },
  M = {
  ...
  C = { loadingText: 'Loading...', cancelText: 'Close', okText: 'Confirm' },
  F = { exportModalTitle: 'Export data', fileType: 'File type', fileName: 'File name' },
  _ = {
    putAway: 'Put away',
    unfold: 'Unfold',
  ...
  R = { onlinePreview: 'Preview', onlineDocument: 'Document' },
  j = {
  ...
  ke = { footer: R, header: j, multipleTab: N, setting: I },
  Me = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: ke, footer: R, header: j, multipleTab: N, setting: I },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  z = 'Login',
  H = 'Error Log',
  Ce = { login: z, errorLogList: H },
  Fe = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Ce, errorLogList: H, login: z },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  W = 'Workbench',
  V = 'Analysis',
  _e = { dashboard: U, about: q, workbench: W, analysis: V },
  ve = Object.freeze(
    Object.defineProperty(
      { __proto__: null, about: q, analysis: V, dashboard: U, default: _e, workbench: W },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  K = { name: 'Graphics editor', flowChart: 'FlowChart' },
  Y = {
    form: 'Form',
    basic: 'Basic',
    useForm: 'useForm',
  ...
  Be = { api: ie, app: se, errorLog: le, exception: ce, lock: de, login: ue },
  Ee = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
  ...
  De = Object.assign({
    './en/common.json': xe,
    './en/component.json': we,
    './en/layout.json': Me,
    './en/routes/basic.json': Fe,
    './en/routes/dashboard.json': ve,
    './en/routes/demo.json': Le,
    './en/sys.json': Ee,
  }),
  Ne = {
    message: i(n({}, fe(De, 'en')), { antdLocale: Te }),
    dateLocale: null,
    dateLocaleName: 'en',
  };
