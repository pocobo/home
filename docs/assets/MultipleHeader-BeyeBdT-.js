import { _ as r } from './BasicTable.vue_vue_type_script_setup_true_lang-DPgNZfUv.js';
import './TableImg.vue_vue_type_style_index_0_lang-boLsnDf-.js';
import './index-BpHr8pvE.js';
import { u as i } from './useTable-USe4NIEW.js';
import { getMultipleHeaderColumns as m } from './tableData-B7W8a9YK.js';
import { d as p } from './table-WVnDNY78.js';
import { d as e, Z as s, _ as a, k as n, u as t } from './vue-BjERyvPm.js';
...
const l = { class: 'p-4' },
  K = e({
    ...
    setup(c) {
      const [o] = i({ title: '多级表头示例', api: p, columns: m() });
      return (_, u) => (s(), a('div', l, [n(t(r), { onRegister: t(o) }, null, 8, ['onRegister'])]));
    },
  });
export { K as default };
