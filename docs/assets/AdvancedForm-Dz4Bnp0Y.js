import { _ as a } from './BasicForm.vue_vue_type_script_setup_true_lang-D9zBX_7o.js';
import './BasicForm.vue_vue_type_style_index_0_lang-CbMCLsCL.js';
import './componentMap-C0n90BJh.js';
import { u as r } from './useForm-b1qEKHt-.js';
import { C as i } from '../index.js';
import { P as f } from './index-B24a6rfW.js';
import { d as u, Z as b, a8 as h, a9 as n, k as t, u as o } from './vue-BjERyvPm.js';
...
const H = u({
  ...
  setup(P) {
    ...
    function s() {
      return [
        { field: 'field10', component: 'Input', label: '字段10', colProps: { span: 8 } },
        { field: 'field11', component: 'Input', label: '字段11', colProps: { span: 8 } },
        { field: 'field12', component: 'Input', label: '字段12', colProps: { span: 8 } },
        { field: 'field13', component: 'Input', label: '字段13', colProps: { span: 8 } },
      ];
    }
    const [c] = r({
        labelWidth: 120,
      ...
      p = [];
    for (let e = 14; e < 30; e++)
      p.push({ field: 'field' + e, component: 'Input', label: '字段' + e, colProps: { span: 8 } });
    const [m] = r({
      labelWidth: 120,
      schemas: [...l(), ...s(), { field: '', component: 'Divider', label: '更多字段' }, ...p],
      actionColOptions: { span: 24 },
      compact: !0,
      showAdvancedButton: !0,
      alwaysShowLines: 2,
        ...
        { title: '可折叠表单示例' },
        {
          default: n(() => [
            t(
              o(i),
              { title: '基础收缩示例' },
              { default: n(() => [t(o(a), { onRegister: o(c) }, null, 8, ['onRegister'])]), _: 1 },
            ),
            t(
              o(i),
              { title: '超过3行自动收起，折叠时保留2行', class: 'mt-4' },
              {
                default: n(() => [
                  t(o(a), { onRegister: o(m), onAdvancedChange: d }, null, 8, ['onRegister']),
                ]),
                _: 1,
              },
            ),
