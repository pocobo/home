    ...
    if (typeof i != 'string' && !Array.isArray(i)) {
      for (const a in i)
        if (a !== 'default' && !(a in c)) {
          ...
          l && Object.defineProperty(c, a, l.get ? l : { enumerable: !0, get: () => i[a] });
        }
    }
  }
...
(function (c, u) {
  (function (o) {
    ...
    o.defineMode('pascal', function () {
      function i(r) {
        for (var t = {}, e = r.split(' '), n = 0; n < e.length; ++n) t[e[n]] = !0;
        return t;
      }
      var a = i(
      ...
      function k(r, t) {
        var e = r.next();
        if (e == '#' && t.startOfLine) return r.skipToEnd(), 'meta';
        if (e == '"' || e == "'") return (t.tokenize = v(e)), t.tokenize(r, t);
        if (e == '(' && r.eat('*')) return (t.tokenize = p), p(r, t);
        if (e == '{') return (t.tokenize = d), d(r, t);
        if (/[\[\]\(\),;\:\.]/.test(e)) return null;
        if (/\d/.test(e)) return r.eatWhile(/[\w\.]/), 'number';
        if (e == '/' && r.eat('/')) return r.skipToEnd(), 'comment';
        if (f.test(e)) return r.eatWhile(f), 'operator';
        r.eatWhile(/[\w\$_]/);
        var n = r.current();
        return a.propertyIsEnumerable(n)
          ? 'keyword'
      ...
      function v(r) {
        return function (t, e) {
          for (var n = !1, s, m = !1; (s = t.next()) != null; ) {
            if (s == r && !n) {
              m = !0;
              break;
            }
          ...
          return (m || !n) && (e.tokenize = null), 'string';
        };
      }
      function p(r, t) {
        for (var e = !1, n; (n = r.next()); ) {
          if (n == ')' && e) {
            t.tokenize = null;
            break;
          }
...
var b = y.exports;
const w = h(b),
  j = x({ __proto__: null, default: w }, [b]);
export { j as p };
