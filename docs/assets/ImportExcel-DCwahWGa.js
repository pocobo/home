import { I as d } from './index-CIVgjVCU.js';
    ...
    function f(p) {
      ...
      for (const i of p) {
        const {
          ...
          c = [];
        for (const n of e) c.push({ title: n, dataIndex: n });
        o.value.push({ title: r, dataSource: t, columns: c });
      }
    }
    return (p, i) => {
      const e = k('a-button');
        ...
        l(
          ...
          { title: 'excel数据导入示例' },
          {
            default: m(() => [
              u(
                s(d),
                { onSuccess: f, dateFormat: 'YYYY-MM-DD' },
                {
                  default: m(() => [
                    u(e, { class: 'm-3' }, { default: m(() => [v(' 导入Excel ')]), _: 1 }),
                  ]),
                  _: 1,
                },
              ),
              ...
              D(
                ...
                I(
                  ...
                  (t, r) => (
                    ...
                    l(
                      s(_),
                      { key: r, title: t.title, columns: t.columns, dataSource: t.dataSource },
                      null,
                      8,
                      ['title', 'columns', 'dataSource'],
                    )
                  ),
                ),
                128,
