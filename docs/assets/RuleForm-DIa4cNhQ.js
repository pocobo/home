var m = (g, d, t) =>
  new Promise((f, c) => {
    var b = (e) => {
      ...
      i = (e) => (e.done ? f(e.value) : Promise.resolve(e.value).then(b, _));
    i((t = t.apply(g, d)).next());
  });
...
import { u as F } from './useForm-b1qEKHt-.js';
import { C as V, a as Y } from '../index.js';
import { P as D } from './index-B24a6rfW.js';
import { i as M } from './system-DVoCCBj0.js';
import { n as x } from './antd-BmrhB3rb.js';
import {
  d as I,
  a7 as N,
  Z as w,
    ...
    setup(g) {
      const d = [
          ...
          },
          {
            ...
            rules: [{ required: !0, message: '请输入aa', type: 'array' }],
          },
          {
            field: 'field441',
            component: 'Input',
            ...
            rules: [
              {
                ...
                validator: (o, s) =>
                  m(this, null, function* () {
                    return s
                      ? s === '1'
                        ? Promise.reject('值不能为1')
                        : Promise.resolve()
                      : Promise.reject('值不能为空');
                  }),
                trigger: 'change',
              },
            ],
          ...
          },
          {
            ...
            rules: [{ required: !0, message: '覆盖默认生成的校验信息' }],
          },
          {
            field: 'field8',
            component: 'Input',
        ...
        ] = F({ labelWidth: 120, schemas: d, actionColOptions: { span: 24 } });
      function n() {
      ...
      function C() {
        const o = _();
        t.success('values:' + JSON.stringify(o));
      }
      function h() {
        e({
          field1: 1111,
          ...
          field7: '1',
          field33: '2020-12-12',
          field3: x('2020-12-12', 'YYYY-MM-DD'),
        });
      }
      function k(o) {
        t.success('click search,values:' + JSON.stringify(o));
      }
      return (o, s) => {
        const r = N('a-button');
        return (
              ...
              default: l(() => [
                R('div', j, [
                  a(
                    ...
                    { default: l(() => [p(' 手动校验表单 ')]), _: 1 },
                  ),
                  a(
                    r,
                    { onClick: P, class: 'mr-2' },
                    { default: l(() => [p(' 清空校验信息 ')]), _: 1 },
                  ),
                  a(
                    r,
                    { onClick: C, class: 'mr-2' },
                    { default: l(() => [p(' 获取表单值 ')]), _: 1 },
                  ),
                  a(
                    r,
                    { onClick: h, class: 'mr-2' },
                    { default: l(() => [p(' 设置表单值 ')]), _: 1 },
                  ),
                  a(
                    r,
                    { onClick: u(i), class: 'mr-2' },
                    { default: l(() => [p(' 重置 ')]), _: 1 },
                    8,
                    ['onClick'],
                  ),
                ...
                a(
                  ...
                  {
                    default: l(() => [
                      a(u(q), { onRegister: u(f), onSubmit: k }, null, 8, ['onRegister']),
                    ]),
                    _: 1,
                  },
                ),
