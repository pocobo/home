...
import { C as d, a as f } from '../index.js';
import { P as _ } from './index-B24a6rfW.js';
import { M as a, C as i } from './index-Ck6h_6RS.js';
import { d as g, Z as C, a8 as b, a9 as n, k as s, u as o, l as p } from './vue-BjERyvPm.js';
...
const A = g({
  ...
  setup(h) {
   ...
   return [expression]`,
      ...
      { createMessage: u } = f();
    function l(e) {
      u.success('click search,values:' + JSON.stringify(e));
    }
    return (e, t) => (
      C(),
      b(
        o(_),
        { title: '代码编辑器组件嵌入Form示例' },
        {
          default: n(() => [
            s(
              o(d),
