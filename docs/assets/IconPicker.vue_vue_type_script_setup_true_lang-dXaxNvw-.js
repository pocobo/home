import { f as T, u as U, U as A, a0 as P, z as I, h as H } from '../index.js';
import {
  f,
  c as j,
  u as e,
...
import { c as Q } from './copyTextToClipboard-DUmgQPO1.js';
import { E as B, aH as W, aI as X, aJ as Y } from './antd-BmrhB3rb.js';
const L = {
  prefix: 'ant-design',
  icons: [
    'account-book-filled',
...
function ee(n, p, a) {
  const d = (p - 1) * Number(a);
  return d + Number(a) >= n.length ? n.slice(d, n.length) : n.slice(d, d + Number(a));
}
function le(n, p) {
  const a = f(1),
    d = f(p),
  ...
  return { setCurrentPage: w, getTotal: h, setPageSize: m, getPaginationList: u };
}
const oe = [
    'icon-download-count',
  ...
  te = { class: 'flex justify-between' },
  ie = { key: 0 },
  ne = { class: 'flex flex-wrap px-2' },
  de = ['onClick', 'title'],
  ue = { key: 0, class: 'flex py-2 items-center justify-center' },
  re = { key: 1, class: 'p-5' },
  ae = { key: 0, class: 'cursor-pointer px-2 py-1 flex items-center' },
  me = J({
    inheritAttrs: !1,
    __name: 'IconPicker',
    props: {
    ...
    setup(n, { emit: p }) {
      function a() {
        const l = L.prefix;
        return L.icons.map((r) => `${l}:${r}`);
      }
      function d() {
        return oe.map((l) => l.replace('icon-', ''));
      }
      const u = n,
        h = p,
        w = u.mode === 'svg',
        ...
        { t: v } = H(),
        { prefixCls: C } = T('icon-picker'),
        $ = U(F, 100),
        { getPaginationList: z, getTotal: _, setCurrentPage: S } = le(y, u.pageSize);
      M(() => {
        o.value = u.value;
      }),
        R(
      ...
      function D(l) {
        (o.value = l), u.copy && Q(l, v('component.icon.copy'));
      }
      function F(l) {
        ...
        y.value = m.filter((t) => t.includes(r));
      }
      return (l, r) => (
        i(),
        b(
          e(B),
          {
            ...
            placeholder: e(v)('component.icon.placeholder'),
            class: N(e(C)),
            value: o.value,
            'onUpdate:value': r[1] || (r[1] = (t) => (o.value = t)),
            onClick: V,
            ...
            addonAfter: g(() => [
              c(
                e(Y),
                {
                  ...
                  trigger: 'click',
                  modelValue: x.value,
                  'onUpdate:modelValue': r[0] || (r[0] = (t) => (x.value = t)),
                  overlayClassName: `${e(C)}-popover`,
                },
                {
                  title: g(() => [
                    q('div', te, [
                      c(
                        e(B),
                        {
                          placeholder: e(v)('component.icon.search'),
                          onChange: e($),
                          allowClear: '',
                        },
                        null,
                    ...
                    e(z).length
                      ? (i(),
                        s('div', ie, [
                          c(
                            e(A),
                            { class: 'border border-solid border-t-0' },
                            {
                              default: g(() => [
                                q('ul', ne, [
                                  (i(!0),
                                      ...
                                      (t) => (
                                        ...
                                        s(
                                          'li',
                                          {
                                            key: t,
                                            class: N([
                                              o.value === t ? 'border border-primary' : '',
                                              'p-2 w-1/8 cursor-pointer mr-1 mt-1 flex justify-center items-center border border-solid hover:border-primary',
                                            ]),
                                            onClick: (ce) => D(t),
                                            title: t,
                                          },
                                          [
                                            w
                                              ? (i(), b(P, { key: 0, name: t }, null, 8, ['name']))
                                              : (i(), b(I, { key: 1, icon: t }, null, 8, ['icon'])),
                                          ],
                                          10,
                                          de,
                                        )
                  ...
                  default: g(() => [
                    q(
                      'div',
                      { ref_key: 'trigger', ref: k },
                      [
                        w && o.value
                          ? (i(), s('span', ae, [c(P, { name: o.value }, null, 8, ['name'])]))
                          : (i(),
                            b(
                              I,
                              {
                                key: 1,
                                icon: o.value || 'ion:apps-outline',
                ...
                8,
                ['modelValue', 'overlayClassName'],
              ),
            ]),
            _: 1,
          },
          8,
          ['style', 'placeholder', 'class', 'value', 'allowClear', 'readonly'],
        )
      );
    },
  });
