...
function d(i, r) {
  for (var a = 0; a < r.length; a++) {
    ...
    if (typeof n != 'string' && !Array.isArray(n)) {
      for (const e in n)
        if (e !== 'default' && !(e in i)) {
          const l = Object.getOwnPropertyDescriptor(n, e);
          l && Object.defineProperty(i, e, l.get ? l : { enumerable: !0, get: () => n[e] });
        }
    }
  }
...
(function (i, r) {
  (function (a) {
    ...
    a.defineMode('gherkin', function () {
      ...
      a.defineMIME('text/x-feature', 'gherkin');
  });
})();
var o = c.exports;
const s = t(o),
  S = d({ __proto__: null, default: s }, [o]);
export { S as g };
