...
function q(l, d) {
  for (var i = 0; i < d.length; i++) {
    ...
    if (typeof n != 'string' && !Array.isArray(n)) {
      for (const g in n)
        if (g !== 'default' && !(g in l)) {
          const r = Object.getOwnPropertyDescriptor(n, g);
          r && Object.defineProperty(l, g, r.get ? r : { enumerable: !0, get: () => n[g] });
        }
    }
  }
...
(function (l, d) {
  (function (i) {
    ...
    i.defineMode('livescript', function () {
      var w = function (e, t) {
          var a = t.next || 'start';
          if (a) {
            t.next = t.next;
            ...
            if (e.match((o = s[a])))
              return o.regex && e.match(o.regex)
                ? ((t.next = o.next), o.token)
                : (e.next(), 'error');
          }
          return e.next(), 'error';
        },
        h = {
          ...
          token: function (e, t) {
            for (; e.pos == e.start; ) var a = w(e, t);
            return (
              (t.lastToken = { style: a, indent: e.indentation(), content: e.current() }),
              a.replace(/\./g, ' ')
            );
          },
          indent: function (e) {
            var t = e.lastToken.indent;
            return e.lastToken.content.match(g) && (t += 2), t;
          },
        };
      return h;
    });
    var n = '(?![\\d\\s])[$\\w\\xAA-\\uFFDC](?:(?!\\s)[$\\w\\xAA-\\uFFDC]|-[A-Za-z])*',
      g = RegExp(
      ...
      s = {
        start: [
          ...
          { token: 'identifier', regex: n + '\\s*:(?![:=])' },
          { token: 'variable', regex: n },
        ...
        key: [
          ...
          { token: 'identifier', regex: n, next: 'start' },
    ...
    for (var f in s) {
      ...
      if (c.splice)
        for (var k = 0, m = c.length; k < m; ++k) {
          var u = c[k];
          typeof u.regex == 'string' && (s[f][k].regex = new RegExp('^' + u.regex));
        }
      else typeof u.regex == 'string' && (s[f].regex = new RegExp('^' + c.regex));
    }
    i.defineMIME('text/x-livescript', 'livescript');
  });
})();
var v = A.exports;
const _ = b(v),
  S = q({ __proto__: null, default: _ }, [v]);
export { S as l };
