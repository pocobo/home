    ...
    if (typeof r != 'string' && !Array.isArray(r)) {
      for (const i in r)
        if (i !== 'default' && !(i in o)) {
          ...
          a && Object.defineProperty(o, i, a.get ? a : { enumerable: !0, get: () => r[i] });
        }
    }
  }
...
(function (o, _) {
  (function (t) {
    ...
    var i = [
      ...
      n = r(l);
    t.registerHelper('hintWords', 'idl', i.concat(l));
    var d = new RegExp('^[_a-z¡-￿][_a-z0-9¡-￿]*', 'i'),
      c = /[+\-*&=<>\/@#~$]/,
      p = new RegExp('(and|or|eq|lt|le|gt|ge|ne|not)', 'i');
    function m(e) {
      return e.eatSpace()
        ? null
        : e.match(';')
    ...
    t.defineMode('idl', function () {
      ...
      t.defineMIME('text/x-idl', 'idl');
  });
})();
var s = w.exports;
const h = f(s),
  y = g({ __proto__: null, default: h }, [s]);
export { y as i };
