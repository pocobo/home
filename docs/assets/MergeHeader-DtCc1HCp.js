...
import { u as m } from './useTable-USe4NIEW.js';
import { getMergeHeaderColumns as e } from './tableData-B7W8a9YK.js';
import { d as i } from './table-WVnDNY78.js';
import { d as p, Z as s, _ as a, k as n, u as r } from './vue-BjERyvPm.js';
...
const c = { class: 'p-4' },
  K = p({
    __name: 'MergeHeader',
    setup(_) {
      const [o] = m({ title: '合并单元格', bordered: !0, api: i, columns: e() });
      return (d, l) => (s(), a('div', c, [n(r(t), { onRegister: r(o) }, null, 8, ['onRegister'])]));
    },
  });
export { K as default };
