...
var d = (i, e, t) =>
    e in i ? y(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t),
  u = (i, e) => {
    for (var t in e || (e = {})) v.call(e, t) && d(i, t, e[t]);
    if (f) for (var t of f(e)) w.call(e, t) && d(i, t, e[t]);
    return i;
  },
  h = (i, e) => b(i, k(e));
var _ = (i, e, t) =>
  new Promise((s, n) => {
    var m = (r) => {
      ...
      a = (r) => (r.done ? s(r.value) : Promise.resolve(r.value).then(m, o));
...
import { g as S } from './system-DVoCCBj0.js';
import { P as A } from './index-B24a6rfW.js';
import { _ as B } from './DeptTree.vue_vue_type_script_setup_true_lang-BRODxoeR.js';
import { d as P } from './account.data-NwbOCzpY.js';
import { V as R } from './index-BQy9w92F.js';
import {
  d as T,
  f as g,
  r as V,
...
const z = [
    { title: '用户名', field: 'account', width: 120 },
    { title: '昵称', field: 'nickname', width: 120 },
    { title: '邮箱', field: 'email', width: 120 },
    { title: '创建时间', field: 'createTime', width: 180 },
    { title: '角色', field: 'role', width: 200 },
    { title: '所属部门', field: 'dept', slots: { default: ({ row: i }) => P[i.dept] } },
    { title: '备注', field: 'remark' },
    { width: 160, title: '操作', align: 'center', slots: { default: 'action' }, fixed: 'right' },
  ],
  F = [
    { field: 'account', title: '用户名', itemRender: { name: 'AInput' }, span: 6 },
    { field: 'nickname', title: '昵称', itemRender: { name: 'AInput' }, span: 6 },
    {
      span: 12,
      align: 'right',
      className: '!pr-0',
  ...
  H = { class: 'm-4 vxebasic-form-container' },
  ge = T({
    __name: 'index',
    setup(i) {
      const e = g(),
        ...
        s = V({
          ...
          keepSource: !0,
          columns: z,
          formConfig: { enabled: !0, items: F },
          height: 'auto',
          proxyConfig: {
            ajax: {
              query: (r) =>
                _(this, [r], function* ({ page: o, form: a }) {
                  return S(
                    h(u({ page: o.currentPage, pageSize: o.pageSize }, a), { searchInfo: t.value }),
                  );
                }),
            },
          },
        ...
        n = (o = '') => {
          (t.value = o), e.value && e.value.commitProxy('query');
        },
        m = (o) => [
          { label: '详情', onClick: () => {} },
          { label: '编辑', onClick: () => {} },
      ...
      return (o, a) => (
        ...
        N(
          ...
          {
            default: x(() => [
              c(B, { class: 'w-1/4 xl:w-1/5', onSelect: n }),
              $('div', H, [
                c(
                  p(R),
                  ...
                  {
                    action: x(({ row: r }) => [
                      c(p(C), { outside: '', actions: m(r) }, null, 8, ['actions']),
                    ]),
                    _: 1,
                  },
                  16,
