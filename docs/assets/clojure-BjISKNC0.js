    ...
    if (typeof i != 'string' && !Array.isArray(i)) {
      for (const a in i)
        if (a !== 'default' && !(a in d)) {
          ...
          s && Object.defineProperty(d, a, s.get ? s : { enumerable: !0, get: () => i[a] });
        }
    }
  }
...
(function (d, u) {
  (function (o) {
    ...
    o.defineMode('clojure', function (i) {
      var a = ['false', 'nil', 'true'],
        s = [
          '.',
          'catch',
          'def',
      ...
      o.registerHelper('hintWords', 'clojure', [].concat(a, s, m));
      var v = l(a),
        g = l(s),
        x = l(m),
        k = l(b),
      ...
      function p(t, e) {
        ...
        if (t.match(q)) return [null, 'number'];
        if (t.match(j)) return [null, 'string-2'];
        if (t.eat(/^"/)) return (e.tokenize = z)(t, e);
          ...
          return (
            n !== 'space' &&
              (e.lastToken === '(' && e.ctx.indentTo === null
                ? n === 'symbol' && c(h, k)
                  ? (e.ctx.indentTo = e.ctx.start + i.indentUnit)
                  : (e.ctx.indentTo = 'next')
      ...
      o.defineMIME('text/x-clojure', 'clojure'),
      o.defineMIME('text/x-clojurescript', 'clojure'),
      o.defineMIME('application/edn', 'clojure');
  });
})();
var y = O.exports;
const P = S(y),
  I = M({ __proto__: null, default: P }, [y]);
export { I as c };
