...
var ft = (e, t, o) =>
    t in e ? Ft(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (e[t] = o),
  dt = (e, t) => {
    for (var o in t || (t = {})) kt.call(t, o) && ft(e, o, t[o]);
    if (lt) for (var o of lt(t)) zt.call(t, o) && ft(e, o, t[o]);
    return e;
  };
var gt = (e, t, o) =>
  new Promise((i, r) => {
    var n = (a) => {
      ...
      u = (a) => (a.done ? i(a.value) : Promise.resolve(a.value).then(n, s));
    u((o = o.apply(e, t)).next());
  });
import { w as Ht } from '../index.js';
import { f as Vt, l as Kt } from './antd-BmrhB3rb.js';
import { d as Jt } from './download-B80gEl-k.js';
import {
  d as Ot,
  f as Yt,
  o as $t,
...
(function (e) {
  ...
  (e.isValid = function (i) {
    return i && typeof i.bit != 'undefined' && i.bit >= 0 && i.bit < 4;
  }),
    (e.from = function (i, r) {
...
H.prototype.set = function (e, t, o, i) {
...
H.prototype.xor = function (e, t, o) {
...
var At = {};
const te = T.getSymbolSize,
  mt = 7;
At.getPositions = function (t) {
  const o = te(t);
  return [
    [0, 0],
    [o - mt, 0],
...
(function (e) {
  ...
  (e.isValid = function (r) {
    ...
    (e.getPenaltyN2 = function (r) {
      ...
      for (let u = 0; u < n - 1; u++)
        for (let a = 0; a < n - 1; a++) {
          const l = r.get(u, a) + r.get(u, a + 1) + r.get(u + 1, a) + r.get(u + 1, a + 1);
          (l === 4 || l === 0) && s++;
        }
      return s * t.N2;
    }),
  ...
  (e.applyMask = function (r, n) {
    const s = n.size;
    for (let u = 0; u < s; u++)
      for (let a = 0; a < s; a++) n.isReserved(a, u) || n.xor(a, u, o(r, a, u));
  }),
...
$.getTotalCodewordsCount = function (t, o) {
  switch (o) {
    case R.L:
      return K[(t - 1) * 4 + 0];
    case R.M:
...
(function () {
  let t = 1;
  for (let o = 0; o < 255; o++) (k[o] = t), (J[t] = o), (t <<= 1), t & 256 && (t ^= 285);
  for (let o = 255; o < 512; o++) k[o] = k[o - 255];
})();
j.log = function (t) {
...
(function (e) {
  ...
  (e.mul = function (i, r) {
    ...
    for (let s = 0; s < i.length; s++)
      for (let u = 0; u < r.length; u++) n[s + u] ^= t.mul(i[s], r[u]);
    return n;
  }),
    (e.mod = function (i, r) {
    ...
    (e.generateECPolynomial = function (i) {
      ...
      for (let n = 0; n < i; n++) r = e.mul(r, new Uint8Array([1, t.exp(n)]));
      return r;
    });
})(Tt);
const Nt = Tt;
...
M.BYTE = new RegExp(re, 'g');
M.NUMERIC = new RegExp(Mt, 'g');
M.ALPHANUMERIC = new RegExp(ne, 'g');
const oe = new RegExp('^' + z + '$'),
  ie = new RegExp('^' + Mt + '$'),
  se = new RegExp('^[A-Z0-9 $%*+\\-./:]+$');
...
(function (e) {
  const t = T,
    ...
    u = t.getBCHDigit(s);
  function a(m, f, d) {
    for (let w = 1; w <= 40; w++) if (f <= e.getCapacity(w, d, m)) return w;
  }
  function l(m, f) {
  ...
  function E(m, f) {
    for (let d = 1; d <= 40; d++) if (c(m, d) <= e.getCapacity(d, f, r.MIXED)) return d;
  }
  (e.from = function (f, d) {
    return n.isValid(f) ? parseInt(f, 10) : d;
  }),
    (e.getCapacity = function (f, d, w) {
      if (!n.isValid(f)) throw new Error('Invalid QR Code version');
      typeof w == 'undefined' && (w = r.BYTE);
      const A = t.getSymbolTotalCodewords(f),
        C = o.getTotalCodewordsCount(f, d),
        y = (A - C) * 8;
      if (w === r.MIXED) return y;
      const g = y - l(w, f);
      switch (w) {
        case r.NUMERIC:
    ...
    (e.getBestVersionForData = function (f, d) {
      let w;
      const A = i.from(d, i.M);
      if (Array.isArray(f)) {
        if (f.length > 1) return E(f, A);
    ...
    (e.getEncodedBits = function (f) {
      ...
      let d = f << 12;
      for (; t.getBCHDigit(d) - u >= 0; ) d ^= s << (t.getBCHDigit(d) - u);
      return (f << 12) | d;
    });
})(St);
var bt = {};
const et = T,
  Pt = 1335,
  ae = 21522,
  wt = et.getBCHDigit(Pt);
bt.getEncodedBits = function (t, o) {
  const i = (t.bit << 3) | o;
  let r = i << 10;
  for (; et.getBCHDigit(r) - wt >= 0; ) r ^= Pt << (et.getBCHDigit(r) - wt);
  return ((i << 10) | r) ^ ae;
};
var Rt = {};
const ue = L;
function D(e) {
  (this.mode = ue.NUMERIC), (this.data = e.toString());
}
...
D.prototype.write = function (t) {
  ...
  for (o = 0; o + 3 <= this.data.length; o += 3)
    (i = this.data.substr(o, 3)), (r = parseInt(i, 10)), t.put(r, 10);
  const n = this.data.length - o;
  n > 0 && ((i = this.data.substr(o)), (r = parseInt(i, 10)), t.put(r, n * 3 + 1));
};
var ce = D;
const le = L,
  q = [
...
function _(e) {
  (this.mode = le.ALPHANUMERIC), (this.data = e);
}
...
_.prototype.write = function (t) {
  ...
  for (o = 0; o + 2 <= this.data.length; o += 2) {
    let i = q.indexOf(this.data[o]) * 45;
    (i += q.indexOf(this.data[o + 1])), t.put(i, 11);
  }
  this.data.length % 2 && t.put(q.indexOf(this.data[o]), 6);
};
var fe = _,
  de = function (t) {
    for (var o = [], i = t.length, r = 0; r < i; r++) {
      ...
      if (n < 2048) {
        o.push((n >> 6) | 192), o.push((n & 63) | 128);
        continue;
      }
      if (n < 55296 || (n >= 57344 && n < 65536)) {
        o.push((n >> 12) | 224), o.push(((n >> 6) & 63) | 128), o.push((n & 63) | 128);
        continue;
      }
...
const ge = de,
  he = L;
function U(e) {
  (this.mode = he.BYTE), typeof e == 'string' && (e = ge(e)), (this.data = new Uint8Array(e));
}
...
const we = L,
  Ce = T;
function v(e) {
  (this.mode = we.KANJI), (this.data = e);
}
...
(function (e) {
  var t = {
    single_source_shortest_paths: function (o, i, r) {
      var n = {},
        s = {};
      s[i] = 0;
      var u = t.PriorityQueue.make();
      u.push(i, 0);
      for (var a, l, c, E, m, f, d, w, A; !u.empty(); ) {
        (a = u.pop()), (l = a.value), (E = a.cost), (m = o[l] || {});
        for (c in m)
          m.hasOwnProperty(c) &&
            ((f = m[c]),
            (d = E + f),
            (w = s[c]),
            (A = typeof s[c] == 'undefined'),
            (A || w > d) && ((s[c] = d), u.push(c, d), (n[c] = l)));
      }
      if (typeof r != 'undefined' && typeof s[r] == 'undefined') {
        var C = ['Could not find a path from ', i, ' to ', r, '.'].join('');
        throw new Error(C);
      }
      return n;
    },
    extract_shortest_path_from_predecessor_list: function (o, i) {
      for (var r = [], n = i; n; ) r.push(n), o[n], (n = o[n]);
      return r.reverse(), r;
    },
    find_path: function (o, i, r) {
      var n = t.single_source_shortest_paths(o, i, r);
    ...
    PriorityQueue: {
      make: function (o) {
        ...
        return (r.queue = []), (r.sorter = o.sorter || i.default_sorter), r;
      },
      default_sorter: function (o, i) {
        return o.cost - i.cost;
      },
      push: function (o, i) {
        var r = { value: o, cost: i };
...
(function (e) {
  ...
  function c(C, y, g) {
    ...
    let p;
    for (; (p = C.exec(g)) !== null; )
      h.push({ data: p[0], index: p.index, mode: y, length: p[0].length });
    return h;
  }
  function E(C) {
    const y = c(s.NUMERIC, t.NUMERIC, C),
      g = c(s.ALPHANUMERIC, t.ALPHANUMERIC, C);
    let h, p;
    return (
      u.isKanjiModeEnabled()
        ? ((h = c(s.BYTE, t.BYTE, C)), (p = c(s.KANJI, t.KANJI, C)))
        : ((h = c(s.BYTE_KANJI, t.BYTE, C)), (p = [])),
      y
        .concat(g, h, p)
        .sort(function (I, N) {
    ...
    for (let g = 0; g < C.length; g++) {
      ...
      switch (h.mode) {
        case t.NUMERIC:
          y.push([
            h,
            { data: h.data, mode: t.ALPHANUMERIC, length: h.length },
            { data: h.data, mode: t.BYTE, length: h.length },
          ]);
          break;
        case t.ALPHANUMERIC:
          y.push([h, { data: h.data, mode: t.BYTE, length: h.length }]);
          break;
        case t.KANJI:
          y.push([h, { data: h.data, mode: t.BYTE, length: l(h.data) }]);
          break;
        case t.BYTE:
          y.push([{ data: h.data, mode: t.BYTE, length: l(h.data) }]);
      }
    }
    return y;
  }
  function w(C, y) {
    ...
    for (let B = 0; B < C.length; B++) {
      ...
      for (let P = 0; P < I.length; P++) {
        const S = I[P],
          F = '' + B + P;
        N.push(F), (g[F] = { node: S, lastCount: 0 }), (h[F] = {});
        for (let G = 0; G < p.length; G++) {
          const b = p[G];
          g[b] && g[b].node.mode === S.mode
            ? ((h[b][F] = m(g[b].lastCount + S.length, S.mode) - m(g[b].lastCount, S.mode)),
              (g[b].lastCount += S.length))
            : (g[b] && (g[b].lastCount = S.length),
              (h[b][F] = m(S.length, S.mode) + 4 + t.getCharCountIndicator(S.mode, y)));
        }
      }
      p = N;
    }
    for (let B = 0; B < p.length; B++) h[p[B]].end = 0;
    return { map: h, table: g };
  }
  function A(C, y) {
    let g;
    const h = t.getBestModeForData(C);
    if (((g = t.from(y, h)), g !== t.BYTE && g.bit < h.bit))
      throw new Error(
        '"' +
          C +
 ...
 Suggested mode is: ` +
    ...
    switch ((g === t.KANJI && !u.isKanjiModeEnabled() && (g = t.BYTE), g)) {
      case t.NUMERIC:
        return new o(C);
      case t.ALPHANUMERIC:
        return new i(C);
  ...
  (e.fromArray = function (y) {
    return y.reduce(function (g, h) {
      return typeof h == 'string' ? g.push(A(h, null)) : h.data && g.push(A(h.data, h.mode)), g;
    }, []);
  }),
    (e.fromString = function (y, g) {
      const h = E(y, u.isKanjiModeEnabled()),
        p = d(h),
        B = w(p, g),
        I = a.find_path(B.map, 'start', 'end'),
        N = [];
      for (let P = 1; P < I.length - 1; P++) N.push(B.table[I[P]].node);
      return e.fromArray(f(N));
    }),
    (e.rawSplit = function (y) {
      return e.fromArray(E(y, u.isKanjiModeEnabled()));
    });
})(Rt);
const Q = T,
  X = Y,
...
function be(e) {
  ...
  for (let o = 8; o < t - 8; o++) {
    const i = o % 2 === 0;
    e.set(o, 6, i, !0), e.set(6, o, i, !0);
  }
}
function Pe(e, t) {
  const o = Ae.getPositions(t);
...
function x(e, t, o) {
  const i = e.size,
    r = Ne.getEncodedBits(t, o);
  let n, s;
  for (n = 0; n < 15; n++)
    (s = ((r >> n) & 1) === 1),
      n < 6 ? e.set(n, 8, s, !0) : n < 8 ? e.set(n + 1, 8, s, !0) : e.set(i - 15 + n, 8, s, !0),
      n < 8
        ? e.set(8, i - n - 1, s, !0)
        : n < 9
...
function Le(e, t) {
  ...
  let i = -1,
    ...
    n = 7,
    s = 0;
  for (let u = o - 1; u > 0; u -= 2)
    for (u === 6 && u--; ; ) {
      for (let a = 0; a < 2; a++)
        if (!e.isReserved(r, u - a)) {
          let l = !1;
          s < t.length && (l = ((t[s] >>> n) & 1) === 1),
            e.set(r, u - a, l),
            n--,
            n === -1 && (s++, (n = 7));
        }
...
function De(e, t, o) {
  ...
  o.forEach(function (a) {
    i.put(a.mode.bit, 4), i.put(a.getLength(), Se.getCharCountIndicator(a.mode, e)), a.write(i);
  });
  ...
  for (let a = 0; a < u; a++) i.put(a % 2 ? 17 : 236, 8);
  return _e(i, e, t);
}
function _e(e, t, o) {
  const i = Q.getSymbolTotalCodewords(t),
    r = rt.getTotalCodewordsCount(t, o),
    n = i - r,
    s = rt.getBlocksCount(t, o),
    u = i % s,
    a = s - u,
    l = Math.floor(i / s),
    c = Math.floor(n / s),
  ...
  for (let I = 0; I < s; I++) {
    const N = I < a ? c : E;
    (w[I] = y.slice(d, d + N)), (A[I] = f.encode(w[I])), (d += N), (C = Math.max(C, N));
  }
  const g = new Uint8Array(i);
  let h = 0,
    p,
    B;
  for (p = 0; p < C; p++) for (B = 0; B < s; B++) p < w[B].length && (g[h++] = w[B][p]);
  for (p = 0; p < m; p++) for (B = 0; B < s; B++) g[h++] = A[B][p];
  return g;
}
function Ue(e, t, o, i) {
  let r;
  if (Array.isArray(e)) r = Z.fromArray(e);
    ...
    let l = t;
    if (!l) {
      const c = Z.rawSplit(e);
      l = O.getBestVersionForData(c, o);
    }
    r = Z.fromString(e, l || 40);
  } else throw new Error('Invalid data');
  const n = O.getBestVersionForData(r, o);
...
`,
  ...
  return (
    ...
    t >= 7 && Re(a, t),
    Le(a, s),
    isNaN(i) && (i = nt.getBestMask(a, x.bind(null, a, o))),
    nt.applyMask(i, a),
    x(a, o, i),
    { modules: a, version: t, errorCorrectionLevel: o, maskPattern: i, segments: r }
  );
}
Et.create = function (t, o) {
  ...
  return (
    typeof o != 'undefined' &&
      ((i = X.from(o.errorCorrectionLevel, X.M)),
      (r = O.from(o.version)),
      (n = nt.from(o.maskPattern)),
      o.toSJISFunc && Q.setToSJISFunction(o.toSJISFunc)),
    Ue(t, r, i, n)
  );
};
var Dt = {},
...
(function (e) {
  function t(o) {
    ...
    if (i.length < 3 || i.length === 5 || i.length > 8) throw new Error('Invalid hex color: ' + o);
  ...
  (e.getOptions = function (i) {
    i || (i = {}), i.color || (i.color = {});
    const r = typeof i.margin == 'undefined' || i.margin === null || i.margin < 0 ? 4 : i.margin,
    ...
    return {
      ...
      scale: n ? 4 : s,
      margin: r,
      color: { dark: t(i.color.dark || '#000000ff'), light: t(i.color.light || '#ffffffff') },
      type: i.type,
    ...
    (e.getImageWidth = function (i, r) {
      const n = e.getScale(i, r);
      return Math.floor((i + r.margin * 2) * n);
    }),
    (e.qrToImageData = function (i, r, n) {
      const s = r.modules.size,
        u = r.modules.data,
        a = e.getScale(s, n),
        l = Math.floor((s + n.margin * 2) * a),
        c = n.margin * a,
        E = [n.color.light, n.color.dark];
      for (let m = 0; m < l; m++)
        for (let f = 0; f < l; f++) {
          let d = (m * l + f) * 4,
            w = n.color.light;
          if (m >= c && f >= c && m < l - c && f < l - c) {
            const A = Math.floor((m - c) / a),
              C = Math.floor((f - c) / a);
            w = E[u[A * s + C] ? 1 : 0];
          }
          (i[d++] = w.r), (i[d++] = w.g), (i[d++] = w.b), (i[d] = w.a);
        }
    });
})(ut);
(function (e) {
  ...
  (e.render = function (n, s, u) {
    ...
    typeof a == 'undefined' && (!s || !s.getContext) && ((a = s), (s = void 0)),
      s || (l = i()),
      (a = t.getOptions(a));
    const c = t.getImageWidth(n.modules.size, a),
      E = l.getContext('2d'),
      m = E.createImageData(c, c);
    return t.qrToImageData(m.data, n, a), o(E, l, c), E.putImageData(m, 0, 0), l;
  }),
    (e.renderToDataURL = function (n, s, u) {
      let a = u;
      typeof a == 'undefined' && (!s || !s.getContext) && ((a = s), (s = void 0)), a || (a = {});
      const l = e.render(n, s, a),
        c = a.type || 'image/png',
        E = a.rendererOpts || {};
      return l.toDataURL(c, E.quality);
    });
})(Dt);
var _t = {};
const ve = ut;
...
function tt(e, t, o) {
  let i = e + t;
  return typeof o != 'undefined' && (i += ' ' + o), i;
}
function Fe(e, t, o) {
  let i = '',
    r = 0,
  ...
  for (let u = 0; u < e.length; u++) {
    ...
    !a && !n && (n = !0),
      e[u]
        ? (s++,
          (u > 0 && a > 0 && e[u - 1]) ||
            ((i += n ? tt('M', a + o, 0.5 + l + o) : tt('m', r, 0)), (r = 0), (n = !1)),
          (a + 1 < t && e[u + 1]) || ((i += tt('h', s)), (s = 0)))
        : r++;
  }
  return i;
}
_t.render = function (t, o, i) {
  const r = ve.getOptions(o),
    n = t.modules.size,
    s = t.modules.data,
    u = n + r.margin * 2,
    a = r.color.light.a
      ? '<path ' + Ct(r.color.light, 'fill') + ' d="M0 0h' + u + 'v' + u + 'H0z"/>'
      : '',
    l = '<path ' + Ct(r.color.dark, 'stroke') + ' d="' + Fe(s, n, r.margin) + '"/>',
    c = 'viewBox="0 0 ' + u + ' ' + u + '"',
    m =
      ...
      `</svg>
`;
  return typeof i == 'function' && i(null, m), m;
};
const ke = qt,
  ot = Et,
  Ut = Dt,
  ze = _t;
function ct(e, t, o, i, r) {
  const n = [].slice.call(arguments, 1),
    s = n.length,
    u = typeof n[s - 1] == 'function';
  if (!u && !ke()) throw new Error('Callback required as last argument');
  if (u) {
    if (s < 2) throw new Error('Too few arguments provided');
    s === 2
      ? ((r = o), (o = t), (t = i = void 0))
      : s === 3 &&
        (t.getContext && typeof r == 'undefined'
          ? ((r = i), (i = void 0))
          : ((r = i), (i = o), (o = t), (t = void 0)));
  } else {
    if (s < 1) throw new Error('Too few arguments provided');
    return (
      s === 1
        ? ((o = t), (t = i = void 0))
        : s === 2 && !t.getContext && ((i = o), (o = t), (t = void 0)),
      new Promise(function (a, l) {
        try {
          const c = ot.create(o, i);
          a(e(c, t, i));
        } catch (c) {
          l(c);
        }
...
ot.create;
var vt = ct.bind(null, Ut.render),
  He = ct.bind(null, Ut.renderToDataURL);
ct.bind(null, function (e, t, o) {
  return ze.render(e, o);
});
const Ve = ({ canvas: e, content: t, width: o = 0, options: i = {} }) => {
  const r = Vt(i);
  return (
    (r.errorCorrectionLevel = r.errorCorrectionLevel || Je(t)),
    Ke(t, r).then((n) => ((r.scale = o === 0 ? void 0 : (o / n) * 4), vt(e, t, r)))
  );
};
function Ke(e, t) {
  const o = document.createElement('canvas');
  return vt(o, e, t).then(() => o.width);
}
function Je(e) {
  return e.length > 36 ? 'M' : e.length > 16 ? 'Q' : 'H';
}
const Oe = ({ canvas: e, logo: t }) => {
  if (!t)
  ...
  const o = e.width,
    ...
    d = e.getContext('2d');
  if (!d) return;
  yt(d)(f, f, m, m, u), (d.fillStyle = r), d.fill();
  const w = new Image();
  (s || a) && w.setAttribute('crossOrigin', s || 'anonymous'), (w.src = l);
  const A = (y) => {
      d.drawImage(y, E, E, c, c);
    },
    C = (y) => {
      const g = document.createElement('canvas');
      (g.width = E + c), (g.height = E + c);
      const h = g.getContext('2d');
      if (!h || !d || (h.drawImage(y, E, E, c, c), yt(d)(E, E, c, c, a), !d)) return;
      const p = d.createPattern(g, 'no-repeat');
      p && ((d.fillStyle = p), d.fill());
    };
  return new Promise((y) => {
    w.onload = () => {
      a ? C(w) : A(w), y(e.toDataURL());
    };
  });
};
function yt(e) {
  return (t, o, i, r, n) => {
    ...
    return (
      ...
      e.beginPath(),
      e.moveTo(t + n, o),
      e.arcTo(t + i, o, t + i, o + r, n),
      e.arcTo(t + i, o + r, t, o + r, n),
      e.arcTo(t, o + r, t, o, n),
      e.arcTo(t, o, t + i, o, n),
      e.closePath(),
      e
...
const Ye = (e) =>
  ...
  $e = Ot({
    ...
    props: {
      ...
      tag: { type: String, default: 'canvas', validator: (e) => ['canvas', 'img'].includes(e) },
    },
    emits: { done: (e) => !!e, error: (e) => !!e },
    setup(e, { expose: t, emit: o }) {
      ...
      function s() {
        return gt(this, null, function* () {
          try {
            const { tag: a, value: l, options: c = {}, width: E, logo: m } = i,
              f = String(l),
              d = W(n);
            if (!d) return;
            if (a === 'canvas') {
              const w = yield Ye({ canvas: d, width: E, logo: m, content: f, options: c || {} });
              r('done', { url: w, ctx: d.getContext('2d') });
              return;
            }
            if (a === 'img') {
              const w = yield He(f, dt({ errorCorrectionLevel: 'H', width: E }, c));
              (W(n).src = w), r('done', { url: w });
            }
          } catch (a) {
            r('error', a);
          }
      ...
      function u(a) {
        ...
        c instanceof HTMLCanvasElement
          ? (l = c.toDataURL())
          : c instanceof HTMLImageElement && (l = c.src),
          l && Jt({ url: l, fileName: a });
      }
      return (
        $t(s),
        jt(
        ...
        t({ download: u }),
        (a, l) => (
          ht(), Qt('div', null, [(ht(), Gt(Wt(e.tag), { ref_key: 'wrapRef', ref: n }, null, 512))])
        )
      );
    },
  }),
