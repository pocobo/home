var g = (n, s, o) =>
  new Promise((u, l) => {
    var i = (e) => {
      ...
      c = (e) => (e.done ? u(e.value) : Promise.resolve(e.value).then(i, t));
    c((o = o.apply(n, s)).next());
  });
import { v as f, a1 as w, K as m } from '../index.js';
import { f as R, b as p, u as d, w as b, J as r } from './vue-BjERyvPm.js';
function y(n) {
  const s = R(null),
    o = R(!1),
    u = R(null);
  ...
  return [
    i,
    {
      ...
      getSize: () => r(t().getSize()),
      updateTableData: (e, a, S) => t().updateTableData(e, a, S),
      deleteTableDataRecord: (e) => t().deleteTableDataRecord(e),
      ...
      getRowSelection: () => r(t().getRowSelection()),
      getCacheColumns: () => r(t().getCacheColumns()),
      getForm: () => d(u),
      setShowPagination: (e) =>
        g(this, null, function* () {
