import { _ as o } from './Upload1.vue_vue_type_script_setup_true_lang-CC5YVFwW.js';
import { _ as t } from './Upload2.vue_vue_type_script_setup_true_lang-D9KmTVzD.js';
import { _ as m } from './Upload3.vue_vue_type_script_setup_true_lang-sf0yzlzn.js';
import { _ as i } from './Upload4.vue_vue_type_script_setup_true_lang-Ye2r-Jp-.js';
import { P as p } from './index-B24a6rfW.js';
import { d as a, Z as e, a8 as _, a9 as s, k as r, u as f } from './vue-BjERyvPm.js';
...
const M = a({
  ...
  setup(n) {
    return (c, u) => (
      e(), _(f(p), { title: '上传组件示例' }, { default: s(() => [r(o), r(t), r(m), r(i)]), _: 1 })
    );
  },
});
export { M as default };
