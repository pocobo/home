import { b as me } from './antd-BmrhB3rb.js';
import { r as ge } from './index-Ck6h_6RS.js';
function ke(N, z) {
  for (var y = 0; y < z.length; y++) {
    ...
    if (typeof g != 'string' && !Array.isArray(g)) {
      for (const m in g)
        if (m !== 'default' && !(m in N)) {
          const k = Object.getOwnPropertyDescriptor(g, m);
          k && Object.defineProperty(N, m, k.get ? k : { enumerable: !0, get: () => g[m] });
        }
    }
  }
...
(function (N, z) {
  (function (y) {
    ...
    function m(e, t, n, l) {
      var u = e.indented;
      return (
        e.context && e.context.type == 'statement' && n != 'statement' && (u = e.context.indented),
        (e.context = new g(u, t, n, l, null, e.context))
      );
    }
    function k(e) {
    ...
    y.defineMode('clike', function (e, t) {
      var n = e.indentUnit,
        l = t.statementIndentUnit || n,
        u = t.dontAlignCalls,
        d = t.keywords || {},
        M = t.types || {},
        oe = t.builtin || {},
        ...
        le = t.atoms || {},
        v = t.hooks || {},
        ce = t.multiLineStrings,
        se = t.indentStatements !== !1,
        ue = t.indentSwitch !== !1,
        H = t.namespaceSeparator,
        fe = t.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
        de = t.numberStart || /[\d\.]/,
        pe = t.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
        Q = t.isOperatorChar || /[+\-*&%=<>!?|\/]/,
        X = t.isIdentifierChar || /[\w\$_\xa1-\uffff]/,
        Y = t.isReservedIdentifier || !1,
        p,
        F;
      function Z(o, a) {
        var i = o.next();
        ...
        if (i == '"' || i == "'") return (a.tokenize = he(i)), a.tokenize(o, a);
        if (de.test(i)) {
          if ((o.backUp(1), o.match(pe))) return 'number';
          o.next();
        }
        if (fe.test(i)) return (p = i), null;
        if (i == '/') {
          if (o.eat('*')) return (a.tokenize = J), J(o, a);
          if (o.eat('/')) return o.skipToEnd(), 'comment';
        }
        if (Q.test(i)) {
          for (; !o.match(/^\/[\/*]/, !1) && o.eat(Q); );
          return 'operator';
        }
        if ((o.eatWhile(X), H)) for (; o.match(H); ) o.eatWhile(X);
        var f = o.current();
        return b(d, f)
          ? (b(G, f) && (p = 'newstatement'), b(ae, f) && (F = !0), 'keyword')
          : b(M, f)
            ? 'type'
            : b(oe, f) || (Y && Y(f))
              ? (b(G, f) && (p = 'newstatement'), 'builtin')
              : b(le, f)
                ? 'atom'
                : 'variable';
      }
      function he(o) {
        return function (a, i) {
          for (var c = !1, f, I = !1; (f = a.next()) != null; ) {
            if (f == o && !c) {
              I = !0;
              break;
            }
          ...
          return (I || !(c || ce)) && (i.tokenize = null), 'string';
        };
      }
      function J(o, a) {
        for (var i = !1, c; (c = o.next()); ) {
          if (c == '/' && i) {
            a.tokenize = null;
            break;
          }
      ...
      function ee(o, a) {
        t.typeFirstDefinitions && o.eol() && O(a.context) && (a.typeAtEndOfLine = R(o, a, o.pos));
      }
      return {
        startState: function (o) {
          return {
            tokenize: null,
            context: new g((o || 0) - n, 0, 'top', null, !1),
            indented: 0,
            startOfLine: !0,
            prevToken: null,
          };
        ...
        token: function (o, a) {
          ...
          if (
            (o.sol() &&
              (i.align == null && (i.align = !1),
              (a.indented = o.indentation()),
              (a.startOfLine = !0)),
            o.eatSpace())
          )
            return ee(o, a), null;
          p = F = null;
          var c = (a.tokenize || Z)(o, a);
          if (c == 'comment' || c == 'meta') return c;
          if (
            (i.align == null && (i.align = !0),
            p == ';' || p == ':' || (p == ',' && o.match(/^\s*(?:\/\/.*)?$/, !1)))
          )
            for (; a.context.type == 'statement'; ) k(a);
          else if (p == '{') m(a, o.column(), '}');
          else if (p == '[') m(a, o.column(), ']');
          else if (p == '(') m(a, o.column(), ')');
          else if (p == '}') {
            for (; i.type == 'statement'; ) i = k(a);
            for (i.type == '}' && (i = k(a)); i.type == 'statement'; ) i = k(a);
          } else
            p == i.type
              ? k(a)
              : se &&
                (((i.type == '}' || i.type == 'top') && p != ';') ||
                  (i.type == 'statement' && p == 'newstatement')) &&
                m(a, o.column(), 'statement', o.current());
          if (
            (c == 'variable' &&
              (a.prevToken == 'def' ||
                (t.typeFirstDefinitions &&
                  R(o, a, o.start) &&
                  O(a.context) &&
                  o.match(/^\s*\(/, !1))) &&
              (c = 'def'),
          ...
          return (
            c == 'def' && t.styleDefs === !1 && (c = 'variable'),
            (a.startOfLine = !1),
            (a.prevToken = F ? 'def' : c || p),
            ee(o, a),
            c
          );
        },
        indent: function (o, a) {
          if ((o.tokenize != Z && o.tokenize != null) || (o.typeAtEndOfLine && O(o.context)))
            return y.Pass;
          var i = o.context,
            c = a && a.charAt(0),
            f = c == i.type;
          if ((i.type == 'statement' && c == '}' && (i = i.prev), t.dontIndentStatements))
            for (; i.type == 'statement' && t.dontIndentStatements.test(i.info); ) i = i.prev;
          if (v.indent) {
            var I = v.indent(o, i, a, n);
            if (typeof I == 'number') return I;
          }
          var ye = i.prev && i.prev.info == 'switch';
          if (t.allmanIndentation && /[{(]/.test(c)) {
            for (; i.type != 'top' && i.type != '}'; ) i = i.prev;
            return i.indented;
          }
          return i.type == 'statement'
            ...
            : i.align && (!u || i.type != ')')
              ...
              : i.type == ')' && !f
                ? i.indented + l
                : i.indented + (f ? 0 : n) + (!f && ye && !/^(?:case|default)\b/.test(a) ? n : 0);
        },
        electricInput: ue ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
        blockCommentStart: '/*',
        blockCommentEnd: '*/',
    ...
    var _ =
      ...
      ne = r('int long char short double float unsigned signed void bool'),
      re = r('SEL instancetype id Class Protocol BOOL');
    function S(e) {
      return b(ne, e) || /.+_t$/.test(e);
    }
    function A(e) {
      return S(e) || b(re, e);
    }
    var T = 'case do else for if switch while struct enum union',
      L = 'struct enum union';
    function w(e, t) {
    ...
    function x(e, t) {
      if ((e.backUp(1), e.match(/^(?:R|u8R|uR|UR|LR)/))) {
        ...
        return n ? ((t.cpp11RawStringDelim = n[1]), (t.tokenize = q), q(e, t)) : !1;
      }
    ...
    function h(e, t) {
      ...
      var n = [];
      function l(d) {
        if (d) for (var M in d) d.hasOwnProperty(M) && n.push(M);
      }
      l(t.keywords),
        l(t.types),
        l(t.builtin),
        l(t.atoms),
        n.length && ((t.helperType = e[0]), y.registerHelper('hintWords', e[0], n));
      for (var u = 0; u < e.length; ++u) y.defineMIME(e[u], t);
    }
    h(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
      ...
      h('text/x-java', {
        ...
        hooks: {
          ...
          '"': function (e, t) {
            return e.match(/""$/) ? ((t.tokenize = V), t.tokenize(e, t)) : !1;
          },
        },
      ...
      h('text/x-csharp', {
        ...
        hooks: {
          '@': function (e, t) {
            return e.eat('"') ? ((t.tokenize = $), $(e, t)) : (e.eatWhile(/[\w\$_]/), 'meta');
          },
        },
      });
    function V(e, t) {
        ...
        for (var l; (l = t.next()); )
          if (l == '*' && t.eat('/'))
            if (e == 1) {
              n.tokenize = null;
              break;
            } else return (n.tokenize = C(e - 1)), n.tokenize(t, n);
          else if (l == '/' && t.eat('*')) return (n.tokenize = C(e + 1)), n.tokenize(t, n);
        return 'comment';
      };
    }
    h('text/x-scala', {
      ...
      hooks: {
        ...
        '=': function (e, t) {
          var n = t.context;
          return n.type == '}' && n.align && e.eat('>')
            ? ((t.context = new g(n.indented, n.column, n.type, n.info, null, n.prev)), 'operator')
            : !1;
        },
        '/': function (e, t) {
          return e.eat('*') ? ((t.tokenize = C(1)), t.tokenize(e, t)) : !1;
        },
      },
    ...
    h('text/x-kotlin', {
      ...
      hooks: {
        ...
        '"': function (e, t) {
          return (t.tokenize = ie(e.match('""'))), t.tokenize(e, t);
        },
        '/': function (e, t) {
          return e.eat('*') ? ((t.tokenize = C(1)), t.tokenize(e, t)) : !1;
        },
      ...
      h('text/x-objectivec++', {
        ...
        builtin: r(B),
        blockKeywords: r(
          T + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch',
        ),
    ...
    h('text/x-ceylon', {
      ...
      hooks: {
        ...
        '`': function (e, t) {
          return !E || !e.match('`') ? !1 : ((t.tokenize = E), (E = null), t.tokenize(e, t));
        },
        "'": function (e) {
...
var te = be.exports;
const we = me(te),
  _e = ke({ __proto__: null, default: we }, [te]);
export { te as a, _e as c };
