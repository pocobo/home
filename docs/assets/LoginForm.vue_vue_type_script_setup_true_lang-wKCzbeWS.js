var R = (C, r, i) =>
  new Promise((u, v) => {
    var l = (o) => {
      ...
      m = (o) => (o.done ? u(o.value) : Promise.resolve(o.value).then(l, _));
...
const fe = M({
  ...
  setup(C) {
    const r = ne,
      ...
      k = S(!1),
      b = S(!1),
      g = N({ account: 'vben', password: '123456' }),
      { validForm: z } = j(F),
      I = A(() => e(D) === p.LOGIN);
    function E() {
          ...
          try {
            ...
            t &&
              _.success({
                ...
                description: `${l('sys.login.loginSuccessDesc')}: ${t.realName}`,
                duration: 3,
              });
          } catch (t) {
            m({
              title: l('sys.api.errorTip'),
              content: t.message || l('sys.api.networkExceptionMsg'),
              getContainer: () => document.body.querySelector(`.${o}`) || document.body,
            });
          } finally {
            k.value = !1;
          }
              ...
              },
              {
                default: a(() => [
                      ...
                      default: a(() => [
                        s(
                          e(B),
                          {
                            ...
                            placeholder: e(l)('sys.login.userName'),
                            class: 'fix-auto-fill',
                          },
                          null,
                          8,
                      ...
                      default: a(() => [
                        s(
                          e(v),
                          {
                            ...
                            placeholder: e(l)('sys.login.password'),
                          },
                          null,
                          8,
                          ['value', 'placeholder'],
                              ...
                              s(e(u), null, {
                                default: a(() => [
                                  s(
                                    ...
                                    {
                                      default: a(() => [d(c(e(l)('sys.login.rememberMe')), 1)]),
                                      _: 1,
                                    },
                                    8,
                                    ['checked'],
                                ...
                                { style: { 'text-align': 'right' } },
                                {
                                  default: a(() => [
                                    s(
                                      ...
                                      {
                                        default: a(() => [
                                          d(c(e(l)('sys.login.forgetPassword')), 1),
                                        ]),
                                        _: 1,
                                      },
                                    ),
                    ...
                    { class: 'enter-x' },
                    {
                      default: a(() => [
                        s(
                          ...
                          { default: a(() => [d(c(e(l)('sys.login.loginButton')), 1)]), _: 1 },
                          8,
                          ['loading'],
                        ),
                      ]),
                          ...
                          { md: 8, xs: 24 },
                          {
                            default: a(() => [
                              s(
                                ...
                                {
                                  default: a(() => [
                                    d(c(e(l)('sys.login.mobileSignInFormTitle')), 1),
                                  ]),
                                  _: 1,
                                },
                              ),
                          ...
                          { md: 8, xs: 24 },
                          {
                            default: a(() => [
                              s(
                                ...
                                {
                                  default: a(() => [d(c(e(l)('sys.login.qrSignInFormTitle')), 1)]),
                                  _: 1,
                                },
                              ),
                            ]),
                          ...
                          { md: 8, xs: 24 },
                          {
                            default: a(() => [
                              s(
                                ...
                                {
                                  default: a(() => [d(c(e(l)('sys.login.registerButton')), 1)]),
                                  _: 1,
                                },
                              ),
                            ]),
                  ...
                  s(
                    e(ee),
                    { class: 'enter-x' },
                    { default: a(() => [d(c(e(l)('sys.login.otherSignIn')), 1)]), _: 1 },
                  ),
                  V(
                    'div',
                    { class: O(['flex justify-evenly enter-x', `${e(o)}-sign-in-way`]) },
                    [s(e(se)), s(e(ae)), s(e(te)), s(e(le)), s(e(oe))],
                    2,
                  ),
                ]),
                _: 1,
