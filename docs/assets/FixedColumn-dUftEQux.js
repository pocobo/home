...
import { _ as l } from './index-BpHr8pvE.js';
import { u as s } from './useTable-USe4NIEW.js';
import { d as c } from './table-WVnDNY78.js';
import { d as u, Z as o, _, k as f, a9 as x, a8 as b, u as t, ab as h } from './vue-BjERyvPm.js';
...
const w = { class: 'p-4' },
  W = u({
    ...
    setup(C) {
      const n = [
          { title: 'ID', dataIndex: 'id', fixed: 'left', width: 280 },
          { title: '姓名', dataIndex: 'name', width: 260 },
          { title: '地址', dataIndex: 'address' },
          { title: '编号', dataIndex: 'no', width: 300 },
          { title: '开始时间', width: 200, dataIndex: 'beginTime' },
                    ...
                    b(
                      t(l),
                      {
                        ...
                        dropDownActions: [
                          {
                            label: '启用',
                            popConfirm: { title: '是否启用？', confirm: m.bind(null, i) },
                          },
                        ],
                      },
                      null,
