...
function C(a, p) {
  for (var i = 0; i < p.length; i++) {
    ...
    if (typeof u != 'string' && !Array.isArray(u)) {
      for (const c in u)
        if (c !== 'default' && !(c in a)) {
          const o = Object.getOwnPropertyDescriptor(u, c);
          o && Object.defineProperty(a, c, o.get ? o : { enumerable: !0, get: () => u[c] });
        }
    }
  }
...
(function (a, p) {
  (function (i) {
    ...
    i.defineMode('sparql', function (u) {
      var c = u.indentUnit,
        o;
      function d(n) {
      ...
      function F(n, e) {
        ...
        if (t == '"' || t == "'") return (e.tokenize = _(t)), e.tokenize(n, e);
        if (/[{}\(\),\.;\[\]]/.test(t)) return (o = t), 'bracket';
        if (t == '#') return n.skipToEnd(), 'comment';
        if (y.test(t)) return 'operator';
        if (t == ':') return g(n), 'atom';
        if (t == '@') return n.eatWhile(/[a-z\d\-]/i), 'meta';
        if (b.test(t) && n.match(D)) return g(n), 'atom';
        n.eatWhile(/[_\w\d]/);
        var r = n.current();
        return h.test(r) ? 'builtin' : m.test(r) ? 'keyword' : 'variable';
      }
      function g(n) {
      ...
      return {
        ...
        token: function (n, e) {
          ...
          if (
            ...
            f(e, ')', n.column());
          else if (o == '[') f(e, ']', n.column());
          else if (o == '{') f(e, '}', n.column());
          else if (/[\]\}\)]/.test(o)) {
            for (; e.context && e.context.type == 'pattern'; ) s(e);
            e.context &&
              o == e.context.type &&
              (s(e), o == '}' && e.context && e.context.type == 'pattern' && s(e));
          } else
      ...
      i.defineMIME('application/sparql-query', 'sparql');
  });
})();
var v = z.exports;
const E = w(v),
  A = C({ __proto__: null, default: E }, [v]);
export { A as s };
