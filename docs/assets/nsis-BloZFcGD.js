...
import { r as S } from './simple-Cawj9dol.js';
function d(i, r) {
    ...
    if (typeof t != 'string' && !Array.isArray(t)) {
      for (const n in t)
        if (n !== 'default' && !(n in i)) {
          ...
          o && Object.defineProperty(i, n, o.get ? o : { enumerable: !0, get: () => t[n] });
        }
    }
  }
  ...
  (function (e) {
    ...
    e.defineSimpleMode('nsis', {
      start: [
        ...
        { regex: /\$\{(?:Disable|Enable)X64FSRedirection\}/i, token: 'variable-2', dedent: !0 },
        { regex: /(#|;).*/, token: 'comment' },
...
var a = I.exports;
const E = s(a),
  u = d({ __proto__: null, default: E }, [a]);
export { u as n };
